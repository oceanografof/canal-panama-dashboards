    ...
    try:
        ...
        for hoja in hojas:
            ...
            idx = {
                ...
                # Columnas exactas observadas en LakeHouse para NeoPanamax:
                # - saving_water_ac_hm3 / saving_water_cc_hm3: ahorro normal por uso de tinas/WSB
                # - saving_water_ta_ac_hm3 / saving_water_ta_cc_hm3: ahorro de Turn Around usando tinas
                # - total_saving_water_neo_hm3: suma oficial de los cuatro componentes anteriores
                "ahorro_npx_ac_lkh": _find_lkh_col(header_l, exact=["saving_water_ac_hm3"]),
                "ahorro_npx_cc_lkh": _find_lkh_col(header_l, exact=["saving_water_cc_hm3"]),
                "ahorro_npx_ta_ac_lkh": _find_lkh_col(header_l, exact=["saving_water_ta_ac_hm3"]),
                "ahorro_npx_ta_cc_lkh": _find_lkh_col(header_l, exact=["saving_water_ta_cc_hm3"]),
            ...
            _ahorro_npx_ac_lkh = _saving_hm3_from_col("ahorro_npx_ac_lkh")
            _ahorro_npx_cc_lkh = _saving_hm3_from_col("ahorro_npx_cc_lkh")
            _ahorro_npx_ta_ac_lkh = _saving_hm3_from_col("ahorro_npx_ta_ac_lkh")
            _ahorro_npx_ta_cc_lkh = _saving_hm3_from_col("ahorro_npx_ta_cc_lkh")

            _ahorro_npx_tinas_componentes = [
                v for v in [_ahorro_npx_ac_lkh, _ahorro_npx_cc_lkh]
                if v is not None and np.isfinite(float(v))
            ]
            _ahorro_npx_turnaround_componentes = [
                v for v in [_ahorro_npx_ta_ac_lkh, _ahorro_npx_ta_cc_lkh]
                if v is not None and np.isfinite(float(v))
            ]
            _ahorro_npx_tinas_lkh = (
                float(sum(_ahorro_npx_tinas_componentes))
                if _ahorro_npx_tinas_componentes
                else _saving_hm3_from_col("ahorro_npx_tinas_lkh")
            )
            _ahorro_npx_turnaround_lkh = (
                float(sum(_ahorro_npx_turnaround_componentes))
                if _ahorro_npx_turnaround_componentes
                else _saving_hm3_from_col("ahorro_npx_turnaround_lkh")
            )
            _ahorro_npx_total_lkh = _saving_hm3_from_col("ahorro_npx_total_lkh")
            if _ahorro_npx_total_lkh is None:
                _componentes_total_npx = [
                    v for v in [_ahorro_npx_tinas_lkh, _ahorro_npx_turnaround_lkh]
                    if v is not None and np.isfinite(float(v))
                ]
                _ahorro_npx_total_lkh = float(sum(_componentes_total_npx)) if _componentes_total_npx else None
            ...
            out = {
                ...
                "ahorro_npx_total_lkh": _ahorro_npx_total_lkh,
                "ahorro_npx_tinas_lkh": _ahorro_npx_tinas_lkh,
                "ahorro_npx_turnaround_lkh": _ahorro_npx_turnaround_lkh,
                "ahorro_npx_ac_lkh": _ahorro_npx_ac_lkh,
                "ahorro_npx_cc_lkh": _ahorro_npx_cc_lkh,
                "ahorro_npx_ta_ac_lkh": _ahorro_npx_ta_ac_lkh,
                "ahorro_npx_ta_cc_lkh": _ahorro_npx_ta_cc_lkh,
    ...
    try:
        ...
        for hoja in hojas:
            ...
            idx = {
                ...
                # Columnas exactas observadas en LakeHouse para NeoPanamax:
                # ahorro normal por tinas/WSB y ahorro por Turn Around con tinas, separadas por complejo.
                "ahorro_npx_ac_lkh": _find_lkh_col(header_l, exact=["saving_water_ac_hm3"]),
                "ahorro_npx_cc_lkh": _find_lkh_col(header_l, exact=["saving_water_cc_hm3"]),
                "ahorro_npx_ta_ac_lkh": _find_lkh_col(header_l, exact=["saving_water_ta_ac_hm3"]),
                "ahorro_npx_ta_cc_lkh": _find_lkh_col(header_l, exact=["saving_water_ta_cc_hm3"]),
            ...
            return {
                ...
                "ahorros": {
                    ...
                    "npx_ac_hm3": _ahorro_npx_ac_lkh,
                    "npx_cc_hm3": _ahorro_npx_cc_lkh,
                    "npx_ta_ac_hm3": _ahorro_npx_ta_ac_lkh,
                    "npx_ta_cc_hm3": _ahorro_npx_ta_cc_lkh,
    ...
    try:
        ...
        def _row_components(row, idx):
            ...
            return {
                ...
                "Trasvase Alhajuela · Gen Madden + fugas + vertidos": aporte_alh_gat,
...
# Turn Around NPX aplicado como evento operativo independiente.
# Importante: NO se limita ni se descuenta de los NPX/día, porque un Turn Around
# puede representar una maniobra/cambio de dirección adicional aunque el conteo de
# tránsitos NPX normales sea bajo o incluso cero. Así el balance lo calcula también
# cuando no se usan tinas.
n_turnaround_npx_aplicado = max(float(n_turnaround_npx), 0.0) if usar_turnaround_npx else 0.0
n_npx_normal = max(float(n_npx), 0.0)
n_npx_balance_unidades = n_npx_normal + n_turnaround_npx_aplicado
...
consumo_turnaround_npx_modelo = n_turnaround_npx_aplicado * turnaround_npx_consumo_tr_modelo
consumo_turnaround_npx_base_modelo = n_turnaround_npx_aplicado * turnaround_npx_base_tr_modelo
ahorro_turnaround_npx_modelo = n_turnaround_npx_aplicado * turnaround_npx_ahorro_tr_modelo
# Alias usado en exportación y reportes para evitar errores si se descarga el Excel.
...
consumo_turnaround_npx_sidebar = n_turnaround_npx_aplicado * turnaround_npx_consumo_tr_sidebar
consumo_turnaround_npx_base_sidebar = n_turnaround_npx_aplicado * turnaround_npx_base_tr_sidebar
...
ahorro_lkh_npx_ac = _lkh_num_o_none(_ahorros_lkh_dict.get("npx_ac_hm3"))
ahorro_lkh_npx_cc = _lkh_num_o_none(_ahorros_lkh_dict.get("npx_cc_hm3"))
ahorro_lkh_npx_ta_ac = _lkh_num_o_none(_ahorros_lkh_dict.get("npx_ta_ac_hm3"))
ahorro_lkh_npx_ta_cc = _lkh_num_o_none(_ahorros_lkh_dict.get("npx_ta_cc_hm3"))

_ahorro_lkh_npx_tinas_componentes = [
    v for v in [ahorro_lkh_npx_ac, ahorro_lkh_npx_cc]
    if v is not None and np.isfinite(float(v))
]
if _ahorro_lkh_npx_tinas_componentes:
    ahorro_lkh_npx_tinas = float(sum(_ahorro_lkh_npx_tinas_componentes))

_ahorro_lkh_npx_ta_componentes = [
    v for v in [ahorro_lkh_npx_ta_ac, ahorro_lkh_npx_ta_cc]
    if v is not None and np.isfinite(float(v))
]
if _ahorro_lkh_npx_ta_componentes:
    ahorro_lkh_npx_turnaround = float(sum(_ahorro_lkh_npx_ta_componentes))
...
dem_pnx_simple_modelo = _n_pnx_seguro * _vp_fis
dem_pnx_base_modelo = _pnx_consumo_base_con_turnaround(nivel_modelo_ft, _n_pnx_seguro, n_pnx_dud, n_pnx_ddu)
# Diferencia por cambio de dirección PNX: puede subir o bajar consumo frente al PNX simple.
ajuste_cambio_dir_pnx_modelo = dem_pnx_base_modelo - dem_pnx_simple_modelo
...
# En modo Sidebar + ahorro también se aplica el cambio de dirección. Se escala el
# ajuste físico al volumen de tránsito que el usuario haya seleccionado (LakeHouse/manual).
_factor_sidebar_pnx = max(float(vp), 0.0) / max(_vp_fis, 1e-9)
ajuste_cambio_dir_pnx_sidebar = ajuste_cambio_dir_pnx_modelo * _factor_sidebar_pnx
dem_pnx_sidebar_base = max(_n_pnx_seguro * float(vp) + ajuste_cambio_dir_pnx_sidebar, 0.0)
dem_pnx_sidebar_ahorro = max(dem_pnx_sidebar_base - ahorro_cam_corta - ahorro_xfill, 0.0)
vp_sidebar_ahorro = dem_pnx_sidebar_ahorro / max(_n_pnx_seguro, 1.0)

# Para NPX se calcula el promedio diario correcto: NPX normales + eventos Turn Around.
# Si no se usan tinas, Turn Around no genera ahorro, pero sí entra como consumo en el balance.
...
dem_npx_sidebar_base = n_npx_normal * float(vn) + n_turnaround_npx_aplicado * turnaround_npx_base_tr_sidebar
dem_npx_sidebar_ahorro = n_npx_normal * vn_normal_sidebar_ahorro + n_turnaround_npx_aplicado * turnaround_npx_consumo_tr_sidebar

vn_base_modelo = dem_npx_base_modelo / max(n_npx_balance_unidades, 1.0)
vn_efectivo = dem_npx_efectivo_modelo / max(n_npx_balance_unidades, 1.0)
vn_sidebar_ahorro = dem_npx_sidebar_ahorro / max(n_npx_balance_unidades, 1.0)
...
dem_escl_sidebar_ahorro = max(dem_npx_sidebar_ahorro + dem_pnx_sidebar_ahorro, 0.0)
...
# ═══ CÁLCULOS ═══
# El balance usa demandas diarias calculadas directamente. Esto evita perder los
# eventos Turn Around NPX cuando NPX/día es 0 y permite que el cambio de dirección
# PNX afecte el consumo aun cuando se use el modo Sidebar + ahorro.
if modo_balance_esclusajes == "Manual sidebar":
    dem_pnx = max(float(n_pnx) * float(vp), 0.0)
    dem_npx = max(float(n_npx) * float(vn), 0.0)
    vp_balance = float(vp)
    vn_balance = float(vn)
    balance_escl_label = "Manual sidebar"
elif modo_balance_esclusajes == "Sidebar + ahorro":
    dem_pnx = max(dem_pnx_sidebar_ahorro, 0.0)
    dem_npx = max(dem_npx_sidebar_ahorro, 0.0)
    vp_balance = dem_pnx / max(float(n_pnx), 1.0)
    vn_balance = dem_npx / max(n_npx_balance_unidades, 1.0)
    balance_escl_label = "Sidebar + ahorro"
elif modo_balance_esclusajes == "Modelo físico base":
    dem_pnx = max(dem_pnx_base_modelo, 0.0)
    dem_npx = max(dem_npx_base_modelo, 0.0)
    vp_balance = vp_base_modelo
    vn_balance = vn_base_modelo
    balance_escl_label = "Modelo físico base"
else:
    dem_pnx = max(dem_pnx_efectivo_modelo, 0.0)
    dem_npx = max(dem_npx_efectivo_modelo, 0.0)
    vp_balance = vp_efectivo
    vn_balance = vn_efectivo
    balance_escl_label = "Modelo físico + ahorro"

dem_npx_bruto = dem_npx
...
_src_col, _dias_col, _obs_col = st.columns([2.35, 1.05, 1.10])
with _src_col:
...
with _obs_col:
    mostrar_aportes_observados = st.checkbox(
        ...
        help=(
            "Activa u oculta en un solo bloque: Gatún observado, Alhajuela observada, "
            "total observado, trasvase Alhajuela y Gatún observado + trasvase."
        ),
    )
...
if mostrar_aportes_observados:
    ...
    _trasvase_hm3, _trasvase_fuente, _trasvase_comp, _trasvase_origen = _seleccionar_flujo_principal(
    ...
    def _tarjeta_valor_obs(titulo, valor_hm3, detalle="", fuente="", comparacion=""):
        _valor_ok = valor_hm3 is not None and pd.notna(valor_hm3)
        if _valor_ok:
            _hm3 = float(valor_hm3)
            _valor_txt = f"{_hm3:.2f} hm³/d"
            _conv_txt = f"{_hm3 * HM3D2M3S:.2f} m³/s · {_hm3 / CFS2HM3:,.0f} p³/s"
        else:
            _valor_txt = "N/D"
            _conv_txt = "m³/s: N/D · p³/s: N/D"
        _detalle_html = f'<div class="sub">{detalle}</div>' if detalle else ""
        _fuente_html = f'<div class="sub">{fuente}</div>' if fuente else ""
        _comparacion_html = f'<div class="sub">{comparacion}</div>' if comparacion else ""
        st.markdown(
            f'''
            <div class="lkh-card">
                <div class="label">{titulo}</div>
                <div class="value">{_valor_txt}</div>
                <div class="sub">{_conv_txt}</div>
                {_detalle_html}
                {_fuente_html}
                {_comparacion_html}
            </div>
    ...
    with _obs_cols[2]:
        if _res_gat and _res_alh:
            ...
            _tarjeta_valor_obs(
                "📈 Aporte observado total",
                _total_ult_hm3,
                detalle=f"Gatún + Alhajuela · Prom. {dias_kpi_superiores}d: {_total_p7_hm3:.2f} hm³/d",
                fuente=f"Prom. 30d: {_total_p30_hm3:.2f} hm³/d",
            )
        else:
            _tarjeta_valor_obs(
                "📈 Aporte observado total",
                None,
                detalle="Se requiere Gatún y Alhajuela válidos.",
            )
    with _obs_cols[3]:
        _tarjeta_valor_obs(
            "🔁 Trasvase Alhajuela",
            _trasvase_hm3,
            detalle="Generación Madden + fugas Alhajuela + vertidos Madden.",
            fuente=_trasvase_fuente,
            comparacion=_trasvase_comp or "",
        )
    with _obs_cols[4]:
        if _res_gat and _trasvase_hm3 is not None and pd.notna(_trasvase_hm3):
            _gat_mas_trasvase_hm3 = float(_res_gat["ultimo_hm3"]) + float(_trasvase_hm3)
            _tarjeta_valor_obs(
                "🌊 Gatún observado + trasvase Alhajuela",
                _gat_mas_trasvase_hm3,
                detalle="Aporte observado Gatún + trasvase Alhajuela.",
                fuente="Se muestra solo cuando Ver aportes obs. está activo.",
            )
        else:
            _tarjeta_valor_obs(
                "🌊 Gatún observado + trasvase Alhajuela",
                None,
                detalle="Requiere Gatún observado y trasvase Alhajuela válidos.",
            )
    ...
    with st.expander(f"🔔 Alertas LakeHouse por salto diario ({len(_alertas_lista)})", expanded=len(_alertas_lista) > 0):
        if _alertas_lista:
            ...
            st.caption(
                ...
                "evaporación y el trasvase Alhajuela antes de reportar el escenario."
            )
...
with tabs[5]:
    ...
    _dias_ahorros_lkh_opts = [1, 5, 7, 10, 30]
    try:
        _dias_ahorros_lkh_default = int(st.session_state.get("dias_op", _dias_defaults_lkh))
    except Exception:
        _dias_ahorros_lkh_default = 5
    _dias_ahorros_lkh_idx = _dias_ahorros_lkh_opts.index(_dias_ahorros_lkh_default) if _dias_ahorros_lkh_default in _dias_ahorros_lkh_opts else 1
    dias_ahorros_lkh = st.radio(
        "Promedio de ahorros LakeHouse",
        options=_dias_ahorros_lkh_opts,
        index=_dias_ahorros_lkh_idx,
        horizontal=True,
        key="dias_lkh_ahorros_tab",
        help="Calcula los ahorros con los últimos N registros/días del LakeHouse. No cambia el balance; solo el visor de esta pestaña.",
    )
    _info_ahorros_tab_lkh = _obtener_balance_detallado_lkh(int(dias_ahorros_lkh)) or _info_balance_lkh
    _ahorros_tab_dict = (_info_ahorros_tab_lkh or {}).get("ahorros", {}) if isinstance(_info_ahorros_tab_lkh, dict) else {}
    _ah_tab_pnx = _lkh_num_o_none(_ahorros_tab_dict.get("pnx_total_hm3"))
    _ah_tab_npx_total = _lkh_num_o_none(_ahorros_tab_dict.get("npx_total_hm3"))
    _ah_tab_npx_tinas = _lkh_num_o_none(_ahorros_tab_dict.get("npx_tinas_hm3"))
    _ah_tab_npx_turnaround = _lkh_num_o_none(_ahorros_tab_dict.get("npx_turnaround_hm3"))
    _ah_tab_npx_ac = _lkh_num_o_none(_ahorros_tab_dict.get("npx_ac_hm3"))
    _ah_tab_npx_cc = _lkh_num_o_none(_ahorros_tab_dict.get("npx_cc_hm3"))
    _ah_tab_npx_ta_ac = _lkh_num_o_none(_ahorros_tab_dict.get("npx_ta_ac_hm3"))
    _ah_tab_npx_ta_cc = _lkh_num_o_none(_ahorros_tab_dict.get("npx_ta_cc_hm3"))
    _ah_tab_cca = _lkh_num_o_none(_ahorros_tab_dict.get("cca_neo"))

    _ah_tab_comp_total = [v for v in [_ah_tab_pnx, _ah_tab_npx_total] if v is not None and np.isfinite(float(v))]
    _ah_tab_total = float(sum(_ah_tab_comp_total)) if _ah_tab_comp_total else None
    _ah_tab_disponible = _ah_tab_total is not None

    if _ah_tab_disponible:
        st.info(
            f"Ahorros provenientes del LakeHouse incorporados al panel y a la exportación "
            f"(promedio de los últimos {int(dias_ahorros_lkh)} días). "
        ...
        lkh_ah1.metric(
            ...
            f"{_ah_tab_total:.3f} hm³/d",
            delta=f"{_ah_tab_total/CFS2HM3:.0f} cfs",
        )
        lkh_ah2.metric(
            "NPX total LakeHouse",
            f"{_ah_tab_npx_total:.3f} hm³/d" if _ah_tab_npx_total is not None else "—",
            delta="NeoPanamax",
        )
        lkh_ah3.metric(
            "Tinas/WSB NPX",
            f"{_ah_tab_npx_tinas:.3f} hm³/d" if _ah_tab_npx_tinas is not None else "—",
            delta="LakeHouse" if _ah_tab_npx_tinas is not None else "sin columna",
        )
        lkh_ah4.metric(
            "Turn Around NPX",
            f"{_ah_tab_npx_turnaround:.3f} hm³/d" if _ah_tab_npx_turnaround is not None else "—",
            delta="LakeHouse" if _ah_tab_npx_turnaround is not None else "sin columna",
        )
        lkh_ah5.metric(
            "PNX LakeHouse",
            f"{_ah_tab_pnx:.3f} hm³/d" if _ah_tab_pnx is not None else "—",
            delta="saving_water_panamax" if _ah_tab_pnx is not None else "sin columna",
        )
        _rows_ah_lkh = []
        for _mec, _val, _es_volumen in [
            ("PNX · ahorro total LakeHouse", _ah_tab_pnx, True),
            ("NPX · ahorro total LakeHouse", _ah_tab_npx_total, True),
            ("NPX · tinas/WSB LakeHouse", _ah_tab_npx_tinas, True),
            ("NPX · Turn Around LakeHouse", _ah_tab_npx_turnaround, True),
            ("NPX · tinas Agua Clara", _ah_tab_npx_ac, True),
            ("NPX · tinas Cocolí", _ah_tab_npx_cc, True),
            ("NPX · TA Agua Clara", _ah_tab_npx_ta_ac, True),
            ("NPX · TA Cocolí", _ah_tab_npx_ta_cc, True),
            ("NPX · CCA Neo", _ah_tab_cca, False),
        ]:
            if _val is not None:
                if _es_volumen:
                    _rows_ah_lkh.append({
    ...
    ah3.metric("Turn Around NPX",
               f"{consumo_turnaround_npx_modelo:.3f} hm³/d",
               delta=f"Ahorro tinas: {ahorro_turnaround_npx_modelo:.3f} hm³/d")
    ...
    # Los cambios de dirección no siempre son ahorros: pueden ser consumo adicional.
    imp1, imp2, imp3 = st.columns(3)
    imp1.metric(
        "Consumo TA NPX en balance",
        f"{consumo_turnaround_npx_modelo:.3f} hm³/d",
        delta=f"{consumo_turnaround_npx_modelo/CFS2HM3:.0f} cfs"
    )
    imp2.metric(
        "Ajuste cambio dirección PNX",
        f"{ajuste_cambio_dir_pnx_modelo:+.3f} hm³/d",
        delta=f"{ajuste_cambio_dir_pnx_modelo/CFS2HM3:+.0f} cfs"
    )
    imp3.metric(
        "Esclusajes usados en balance",
        f"{dem_escl:.3f} hm³/d",
        delta=f"{balance_escl_label}"
    )
    if n_turnaround_npx_aplicado > 0 and ahorro_turnaround_npx_modelo <= 1e-9:
        st.info(
            "Turn Around NPX está activo sin tinas: no se reporta como ahorro, "
            f"pero sí suma {consumo_turnaround_npx_modelo:.3f} hm³/d al consumo de esclusajes."
        )
    if abs(ajuste_cambio_dir_pnx_modelo) > 1e-9:
        st.info(
            f"Cambio de dirección PNX aplicado: ajuste {ajuste_cambio_dir_pnx_modelo:+.3f} hm³/d "
            "frente al PNX simple. En modo Sidebar + ahorro también se aplica al balance."
        )
    ...
    fig_sen.add_trace(go.Scatter(x=_nv_sens, y=_aho_ta, name="Ahorro tinas TA NPX",
    ...
    tbl_fis = pd.DataFrame([
        ...
        {"Parámetro":"Turn Around NPX/día","Valor":f"{n_turnaround_npx_aplicado:.1f}","Fuente":"Sidebar"},
        {"Parámetro":"Consumo Turn Around NPX por evento sin/según tinas","Valor":f"{turnaround_npx_consumo_tr_modelo:.5f} hm³","Fuente":"Workbook / cálculo"},
        {"Parámetro":"Consumo Turn Around NPX total","Valor":f"{consumo_turnaround_npx_modelo:.4f} hm³/d","Fuente":"Cálculo físico"},
        {"Parámetro":"Ahorro Turn Around NPX por tinas","Valor":f"{ahorro_turnaround_npx_modelo:.4f} hm³/d","Fuente":"Cálculo físico"},
        ...
        {"Parámetro":"Ajuste consumo por cambio dirección PNX","Valor":f"{ajuste_cambio_dir_pnx_modelo:+.4f} hm³/d","Fuente":"Cálculo físico"},
    ])
    ...
    def build_export_excel() -> bytes:
        ...
        with pd.ExcelWriter(buf, engine="openpyxl") as writer:
            ...
            resumen = pd.DataFrame([
                ...
                {"Parámetro":"Turn Around NPX/día aplicado","Valor":n_turnaround_npx_aplicado,"Unidad":"eventos/día"},
                {"Parámetro":"Consumo Turn Around NPX aplicado","Valor":round(consumo_turnaround_npx_modelo,4),"Unidad":"hm³/día"},
                {"Parámetro":"Ahorro Turn Around por tinas","Valor":round(ahorro_turnaround_aplicado,4),"Unidad":"hm³/día"},
                {"Parámetro":"PNX/día","Valor":n_pnx,"Unidad":"esclusajes"},
                {"Parámetro":"NPX/día normal","Valor":n_npx,"Unidad":"esclusajes"},
                {"Parámetro":"NPX unidades para balance","Valor":round(n_npx_balance_unidades,2),"Unidad":"NPX normales + TA"},
                ...
                {"Parámetro":"Cambio dirección PNX Up→Down/día","Valor":n_pnx_dud,"Unidad":"eventos/día"},
                {"Parámetro":"Cambio dirección PNX Down→Up/día","Valor":n_pnx_ddu,"Unidad":"eventos/día"},
                ...
                {"Parámetro":"Ahorro LakeHouse NPX tinas Agua Clara","Valor":round(ahorro_lkh_npx_ac,4) if ahorro_lkh_npx_ac is not None else "N/D","Unidad":"hm³/día"},
                {"Parámetro":"Ahorro LakeHouse NPX tinas Cocolí","Valor":round(ahorro_lkh_npx_cc,4) if ahorro_lkh_npx_cc is not None else "N/D","Unidad":"hm³/día"},
                {"Parámetro":"Ahorro LakeHouse NPX TA Agua Clara","Valor":round(ahorro_lkh_npx_ta_ac,4) if ahorro_lkh_npx_ta_ac is not None else "N/D","Unidad":"hm³/día"},
                {"Parámetro":"Ahorro LakeHouse NPX TA Cocolí","Valor":round(ahorro_lkh_npx_ta_cc,4) if ahorro_lkh_npx_ta_cc is not None else "N/D","Unidad":"hm³/día"},
                ...
                {"Parámetro":"Trasvase Alhajuela aplicado","Valor":round(_aporte_alh_gatun_app,4),"Unidad":"hm³/día"},
...
with tabs[9]:
    ...
    def cargar_lkh(src, sh):
        ...
        for c in df.columns:
            ...
            elif cl=="saving_water_ac_hm3":  rn[c]="ahorro_npx_ac"
            elif cl=="saving_water_cc_hm3":  rn[c]="ahorro_npx_cc"
            elif cl=="saving_water_ta_ac_hm3": rn[c]="ahorro_npx_ta_ac"
            elif cl=="saving_water_ta_cc_hm3": rn[c]="ahorro_npx_ta_cc"
        ...
        # Componentes de ahorro NeoPanamax provenientes del LakeHouse.
        # Se agregan para que la pestaña 📂 Datos Lake House pueda promediar
        # tinas normales y Turn Around por separado aunque el archivo también traiga el total consolidado.
        if "ahorro_npx_ac" in df or "ahorro_npx_cc" in df:
            df["ahorro_npx_tinas"] = sum(
                df[c].fillna(0) for c in ["ahorro_npx_ac", "ahorro_npx_cc"] if c in df
            )
        if "ahorro_npx_ta_ac" in df or "ahorro_npx_ta_cc" in df:
            df["ahorro_npx_turnaround"] = sum(
                df[c].fillna(0) for c in ["ahorro_npx_ta_ac", "ahorro_npx_ta_cc"] if c in df
            )
        if "ahorro_npx" not in df and ("ahorro_npx_tinas" in df or "ahorro_npx_turnaround" in df):
            df["ahorro_npx"] = sum(
                df[c].fillna(0) for c in ["ahorro_npx_tinas", "ahorro_npx_turnaround"] if c in df
            )
    ...
    if dl is not None and len(dl)>0:
        ...
        _ah_lkh_cols = [
            ...
            ("NPX · tinas Agua Clara", "ahorro_npx_ac"),
            ("NPX · tinas Cocolí", "ahorro_npx_cc"),
            ("NPX · TA Agua Clara", "ahorro_npx_ta_ac"),
            ("NPX · TA Cocolí", "ahorro_npx_ta_cc"),
        ]
        _ah_lkh_rows = []
...
with tabs[10]:
    ...
    with paso4:
        ...
        - En **PNX — Eficiencia operativa**, ingrese eventos/día de Cámaras Cortas, CrossFilling PM/Gatún y **Cambio dirección PNX Up→Down / Down→Up**; el balance aplica el ajuste de consumo y descuenta los hm³/d ahorrados.
        - En **NPX — Turn Around**, el evento se calcula aunque no use tinas. Sin tinas se suma como consumo; con tinas se muestra además el ahorro correspondiente.
    ...
    with paso5:
        ...
        - Ahorros por tinas, cámara corta y crossfilling; además, consumo operativo por Turn Around NPX y cambio de dirección PNX.
    ...
    controles = pd.DataFrame([
        ...
        {"Control": "Ver aportes obs.", "Dónde": "Visor principal superior", "Efecto": "Muestra u oculta todo el bloque: Gatún observado, Alhajuela observado, total observado, trasvase Alhajuela y Gatún observado + trasvase Alhajuela."},
    ...
    with c7:
        st.markdown(f"""
        <div class="lkh-card">
            <div class="label">Trasvase Alhajuela</div>
            <div class="value">{_aporte_alh_gatun_app:.3f}</div>
            <div class="sub">hm³/d · {_aporte_alh_gatun_app/CFS2HM3:.1f} p³/s · generación Madden + fugas + vertidos.</div>
        </div>
        """, unsafe_allow_html=True)
    with c8:
    ...
    guia_tabs = pd.DataFrame([
        ...
        {"Pestaña": "📤 Exportar", "Uso principal": "Generar respaldo en Excel.", "Revise antes de reportar": "Parámetros, trasvase Alhajuela, demandas por embalse y hoja de áreas."},
    ...
    reglas = pd.DataFrame([
        ...
        {"Elemento": "Trasvase Alhajuela", "Criterio": "Se calcula como generación Madden + fugas Alhajuela + vertidos Madden. Se muestra dentro del bloque Ver aportes obs. junto con Gatún observado + trasvase Alhajuela."},
        {"Elemento": "Alertas LakeHouse", "Criterio": "Comparan el último día contra el día anterior y alertan saltos bruscos en todas las demandas/volúmenes disponibles, incluyendo trasvase Alhajuela."},
    ...
    with chk2:
        ...
        **Escenario**
        ...
        - Trasvase Alhajuela revisado dentro de Ver aportes obs. si aplica.
        """)
    with chk3:
        st.markdown("""
        **Resultado**
    ...
    st.success("Ruta recomendada: Datos LakeHouse → Alertas LakeHouse → Niveles y área Daily → Tránsitos → Fuente de esclusajes → Evaporación → Aportes observados → Balance → Exportar.")
